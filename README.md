...
Python 3.12 web app that checks where a website ranks for a list of keywords on DuckDuckGo.
...
This app is pinned to **Python 3.12**. Use that interpreter for the virtualenv and runtime.
